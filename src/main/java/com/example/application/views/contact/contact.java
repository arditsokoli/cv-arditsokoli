...
public class contact extends Div {
    ...
    public contact(SamplePersonService personService) {
        ...
        save.addClickListener(e -> {
            ...
            Notification.show( "Details submited.");
            clearForm();
        });
    }
    ...
    private Component createFormLayout() {
        ...
        formLayout.add(firstName, lastName, phone, email, message);
        return formLayout;
    }
    ...
    private static class PhoneNumberField extends CustomField<String> {
        ...
        public PhoneNumberField(String label) {
            ...
            countryCode.setItems("+354","+355", "+91", "+62", "+98", "+964", "+353", "+44", "+972", "+39", "+225");
